...
class IsActualGreaterThanExpectedValueComparerTest
{
    ...
    void testIsExpected_AllNulls_False() throws DatabaseUnitException
    {
        ...
        assertThat(actual).as("All null should have been true.").isFalse();
    }
            ...
            throws DatabaseUnitException
    {
        ...
        final boolean actual = sut.isExpected(expectedTable, actualTable,
                rowNum, columnName, dataType, expectedValue, actualValue);
        assertThat(actual)
                .as("Actual is equal to expected, should not have been true.")
                .isFalse();
    }
