...
class IsActualGreaterThanExpectedWithIgnoreMillisValueComparerTest
{
    ...
    private final IsActualGreaterThanExpectedWithIgnoreMillisValueComparer sut =
            new IsActualGreaterThanExpectedWithIgnoreMillisValueComparer();
    ...
    @Test
    void testIsExpected_ActualEqualToExpected_False()
