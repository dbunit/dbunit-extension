...
class MockBatchStatementTest
{
    ...
    @Test
    void testGetCapturedSql_afterSingleAddBatch_returnsListWithOneEntry() throws Exception
    {
        final MockBatchStatement statement = new MockBatchStatement();
    ...
    @Test
    void testGetCapturedSql_afterAddBatch_containsInsertedSqlStrings() throws Exception
    {
        final MockBatchStatement statement = new MockBatchStatement();
