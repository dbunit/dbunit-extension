...
class AutomaticPreparedBatchStatementTest
{
    ...
    @Test
    void testExecuteBatch_accumulatesResultFromAutoFlushes() throws Exception
    {
        final int threshold = 2;
        when(delegate.executeBatch()).thenReturn(2);
    ...
    @Test
    void testAddValue_delegatesToUnderlyingStatement() throws Exception
    {
        final int threshold = 5;
        final AutomaticPreparedBatchStatement statement =
                new AutomaticPreparedBatchStatement(delegate, threshold);
    ...
    @Test
    void testClose_delegatesToUnderlyingStatement() throws Exception
    {
        final int threshold = 5;
        final AutomaticPreparedBatchStatement statement =
                new AutomaticPreparedBatchStatement(delegate, threshold);
    ...
    @Test
    void testClearBatch_delegatesToUnderlyingStatement() throws Exception
    {
        final int threshold = 5;
        final AutomaticPreparedBatchStatement statement =
                new AutomaticPreparedBatchStatement(delegate, threshold);
