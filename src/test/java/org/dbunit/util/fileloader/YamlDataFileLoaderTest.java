 ...
 * @since 3.6.0
 */
class YamlDataFileLoaderTest
{
    YamlDataFileLoader loader = null;

    @BeforeEach
    protected void setUp() throws Exception
    {
        loader = new YamlDataFileLoader();
    }

    @Test
    void testLoad_withValidYamlFile_returnsDataSetWithExpectedTablesAndRows()
            throws DataSetException
    {
        final String filename = "/yaml/dataSetTest.yml";
