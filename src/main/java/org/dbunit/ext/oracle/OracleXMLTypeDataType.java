...
public class OracleXMLTypeDataType extends BlobDataType
{
            ...
            throws SQLException, TypeCastException
    {
        ...
        final String tempString = typeCast == null? null:new String((byte[]) typeCast);
        log.trace("getSqlValue: column={}, data={}, typeCast={}, tempString={}",
                column, data, typeCast, tempString);
            ...
            throws SQLException, TypeCastException
    {
        ...
        log.trace("setSqlValue: value={}, typeCast={}, string={}", value,
                typeCast, string);
