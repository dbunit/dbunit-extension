 ...
 * greater than expected value, ignoring the milliseconds.
 *
 * @author Jeff Jensen
 * @since 3.1.0
 */
public class IsActualGreaterThanExpectedWithIgnoreMillisValueComparer
        extends TimestampIgnoreMillisValueComparerBase
{
    ...
    {
        return dataType.compare(actualTime, expectedTime) > 0;
    }
