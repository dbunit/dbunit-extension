 ...
 * annotation is what switches the test from the simple setup/teardown path onto the
 * {@link PrepAndExpectedTestCase} prep/expected path.
 *
 ...
 *   <li>{@link #verifyDefinitions()} - every definition in the named catalog class(es),
 *   narrowed to {@link #verifyTables()} when that is also given.</li>
 *   <li>{@link #verify()} - full per-table rules, inline.</li>
 *   <li>{@link #verifyTables()} - a default {@link VerifyTableDefinition} per named table.</li>
