 ...
 * asked for its one value - here {@link #getVerifyTableDefinitions()}. The other members of
 * this family are {@link org.dbunit.util.fileloader.DataSetPathsProvider},
 * {@link org.dbunit.database.DatabaseConfigPropertiesProvider}, and {@link DatabaseTesterFactory}.
 *
 * <p>A catalog class named on either attribute is checked for this interface first: if it
 * implements {@link VerifyTableDefinitionsProvider}, it is instantiated and asked for the
 * definitions; otherwise the catalog's {@code public static final VerifyTableDefinition} fields
 * are read directly and indexed by {@link VerifyTableDefinition#getTableName()}. A plain
 * constants class - no interface, no boilerplate - is the common case; implementing this
