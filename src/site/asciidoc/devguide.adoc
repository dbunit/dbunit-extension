...
link:https://sourceforge.net/p/dbunit/_list/tickets[create a bug or feature ticket for the change].
...
link:https://sourceforge.net/p/dbunit/code.git/merge-requests[merge requests]
...
Refer to link:/dbunit/integrationtests.html[Integration Tests] for setup and running them.
...
merge request,
or link:/dbunit/mail-lists.html[email the dev list].
