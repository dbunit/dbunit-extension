...
based access:
link:../apidocs/org/dbunit/dataset/stream/DataSetProducerAdapter.html[DataSetProducerAdapter]
...
reading), and
link:../apidocs/org/dbunit/dataset/stream/BufferedConsumer.html[BufferedConsumer]
