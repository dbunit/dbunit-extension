...
link:../apidocs/org/dbunit/database/IMetadataHandler.html[IMetadataHandler]
...
link:../apidocs/org/dbunit/database/IMetadataHandler.html[JavaDoc]; grouped by
purpose:
...
link:../apidocs/org/dbunit/database/InMemoryMetadataResultSet.html[InMemoryMetadataResultSet]
