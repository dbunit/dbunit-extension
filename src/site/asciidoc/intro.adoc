...
NOTE: This page is background/motivational reading — an early-2000s essay
explaining *why* database testing matters — not dbUnit-specific
instructions. If you're looking for how to use dbUnit, start with
link:fiveminutes.html[dbUnit in 5 Minutes] or link:howto.html[Getting
Started].
