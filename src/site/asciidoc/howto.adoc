...
You can manually create a link:datasets/flatxml.html[flat XML dataset] from scratch or create one by link:faq.html#extract[exporting] some data from your database.
...
By default, Dbunit performs a link:operations.html#cleanInsert[CLEAN_INSERT] operation before executing each test and performs no cleanup operation afterward.
