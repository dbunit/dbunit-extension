...
link:../apidocs/org/dbunit/ext/hsqldb/HsqldbDataTypeFactory.html[HsqldbDataTypeFactory]
...
link:../apidocs/org/dbunit/ext/hsqldb/HsqldbConnection.html[HsqldbConnection]
