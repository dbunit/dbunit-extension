...
link:../apidocs/org/dbunit/ext/h2/H2DataTypeFactory.html[H2DataTypeFactory]
...
link:../apidocs/org/dbunit/ext/h2/H2MetadataHandler.html[H2MetadataHandler]
...
link:../apidocs/org/dbunit/ext/h2/H2Connection.html[H2Connection] wraps
