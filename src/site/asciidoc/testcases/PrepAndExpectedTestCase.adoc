...
(link:/dbunit/apidocs/org/dbunit/dataset/CompositeDataSet.html[CompositeDataSet] under
...
for you via
link:/dbunit/apidocs/org/dbunit/dataset/filter/DefaultColumnFilter.html[DefaultColumnFilter]
...
link:/dbunit/apidocs/org/dbunit/PrepAndExpectedTestData.html[PrepAndExpectedTestData]
...
link:/dbunit/apidocs/org/dbunit/database/DatabaseConfig.html[DatabaseConfig] - its batch
